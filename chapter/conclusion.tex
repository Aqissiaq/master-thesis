...
paths into the universe which is guaranteed to terminate. The other is to work
towards more computational results. Specifically we are limited by indexed
families, and further work in Cubical Agda's normalization would lead to more
results ``for free''. It would also be interesting to look at the computation of
\texttt{opt}, as it requires some notions of sub-singletons~\cite{Angiuli2016}.
