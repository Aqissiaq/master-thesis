...
\HRule \\[0.5cm]
\begin{Huge}
	\bfseries{A Cubical Implementation of Homotopical Patch Theory}\\[0.7cm] % Title of your document
\end{Huge}
\HRule \\[0.5cm]
...
\large Åsmund Aqissiaq Arild Kløvstad\\
\large Supervised by Håkon Robbestad Gylterud\\[2cm]
...
\centerline{\includegraphics[width=\textwidth]%
  {figures/logo/PNG/English/UiBlogoMN_gray_m_Eng}}
